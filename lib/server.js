...
class Server {
  constructor(options = {}) {
    ...
    this.defaultRequestHeaders = options.defaultRequestHeaders;
    this.defaultResponseHeaders = options.defaultResponseHeaders;
    register();
  }
  ...
  useMiddleware(req, res, next) {
    ...
    extract.incomingRequst(req).then((req) => {
      ...
      if (this.defaultResponseHeaders && agree.response.headers) {
        agree.response.headers = Object.assign(agree.response.headers, this.defaultResponseHeaders);
      }
